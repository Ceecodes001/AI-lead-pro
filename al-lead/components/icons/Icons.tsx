...
export const LeadsIcon: React.FC = () => (
    <svg {...iconProps} viewBox="0 0 24 24">
        <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 3a4 4 0 100 8 4 4 0 000-8zM23 21v-2a4 4 0 00-3-3.87" />
    </svg>
);
...
export const AnalyzeIcon: React.FC = () => (
    <svg className="w-5 h-5" strokeWidth="1.5" stroke="currentColor" fill="none" viewBox="0 0 24 24">
